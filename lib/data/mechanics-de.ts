export const mechanicsDE: any[] = [
  ...
  // ── CATEGORY: content-media ──────────────────────────────────────
  {
    ...
    examples: [
      ...
      {
        company: "Opus Clip",
        detail: "$20M ARR, $215M оценка. 5M+ юзеров за 7 мес. AI нарезает видео на вирусные shorts",
        caseStudy: {
          mechanicInAction: "• Загрузи 1 длинное видео → AI за 10 мин генерирует 10-15 клипов с субтитрами, relayout и virality score\n• Не просто нарезка — AI выбирает хуки, переставляет моменты, добавляет CTA\n• $1M ARR за первые 14 дней после запуска. 5M+ пользователей за 7 месяцев\n• Pivot: начинали с AI live-streaming (200 юзеров за 3 мес) → pivot на clipping → десятки тысяч за 2 нед\n• Клиенты: HubSpot, Juventus, Vox Media, VISA\n• $20M ARR (2025), $215M оценка (SoftBank Vision Fund 2)\n• Основатели: Young Zhao, Grace Wang, Jay Wu — ранее агентство на 500 человек",
          jtbd: "**Core Job:** Получить максимум охвата из контента без видеомонтажёра.\n\n**Functional:** 60-мин видео → 10+ шортов за минуты вместо 8 часов ручной работы.\n\n**Emotional:** Virality score даёт уверенность что клип «залетит».\n\n**Social:** Выглядеть как профи-креатор с регулярным постингом на 5+ платформ.\n\n**Сегменты:** Соло-креаторы, маркетинг-команды, медиа-компании.",
          monetization: "**Тарифы:** Freemium → Pro ~$14.50/мес (annual). Enterprise для команд.\n\n**ARR:** $1M за 14 дней → $10M (2024) → $20M (2025). Рост 2x/год.\n\n**Оценка:** $215M (SoftBank, март 2025). Фандинг: $50M total.\n\nUsage-first: покажи ценность → конвертируй с минимальным трением.",
          marketing: "• Product Hunt запуск → вирусный рост (5M юзеров за 7 мес)\n• Paid social как основной канал (full-time creative lead)\n• Само-подпитывающийся цикл: юзеры создают шортсы → шортсы продвигают Opus Clip\n• Virality score как геймификация — маркетинговый хук\n• Pivot story как PR: AI live-streaming → clipping = 100x рост",
          impact: "**Для клиента:** Время: 8ч → 10 мин (−85%). Количество: 3-5 → 10-15 клипов. Субтитры: >97% точность.\n\n**Для компании:** $0 → $20M ARR. 5M+ юзеров. $215M оценка. HubSpot, VISA, Juventus, Vox Media.",
          tocConstraint: "**Ограничение:** Время монтажёра. 60-мин подкаст = 8ч монтажа = 3-5 клипов. Bottleneck всей content-воронки.\n\n**Решение:** 10 мин AI = 10-15 клипов. Throughput +20-50x.\n\n**Куда сместилось:** Качество исходного якорного контента + дистрибуция по платформам.",
          trizContradictions: "**ТП #1:** Больше контента (объём) vs Качество монтажа. #10 Предварительное действие: AI обучен на тысячах вирусных видео. #15 Динамичность: crop, субтитры, CTA под платформу.\n\n**ТП #2:** Персонализация (каждый клип уникален) vs Скорость (10 мин). #1 Дробление: видео → семантические сегменты → параллельная обработка.\n\n**Физическое:** КОРОТКИЙ (для платформ) и СОДЕРЖАТЕЛЬНЫЙ (для ценности). AI выбирает моменты с максимальной плотностью смысла.",
          conditions: "**Якорный контент:** Есть подкасты/вебинары (long-form) которые недоиспользуются.\n\n**Платформы:** TikTok, Reels, Shorts требуют высокую частоту постинга.\n\n**Стоимость:** Ручной монтаж непропорционально дорог vs value одного клипа.\n\n**Timing:** Short-form video бум 2023-2025. AI video models созрели.\n\n**НЕ работает:** Нет long-form, или B2B с узкой аудиторией.",
          mvpVersion: "**Гипотеза:** Креаторы заплатят за AI-нарезку длинных видео на шортсы.\n\n**Эксперимент (как Opus Clip):** Один input (URL/файл). AI нарезает на 5 клипов с субтитрами. Без аккаунтов, без оплаты — value-first.\n\n**Метрика:** % юзеров, скачавших ≥1 клип.\n\n**Следующий шаг:** Pro план, virality score, multi-platform export.",
        },
      },
      {
    ...
    examples: [
      {
        ...
        detail: "150K+ подписчиков, $1M+/год. Крупнейший AI newsletter. Ex-Makerpad → Zapier",
        caseStudy: {
          mechanicInAction: "• Ben Tossell запустил Ben's Bites в октябре 2022 — ежедневный дайджест AI-новостей\n• За 13 мес — 100K подписчиков, сейчас 150K+\n• Community-driven: Ben's Bites News (аналог HN для AI) — юзеры сабмитят и голосуют, снижая нагрузку\n• До этого: Makerpad (no-code) → продал Zapier в 2021 при $400K ARR\n• Эволюция: рассылка → Pro ($100 lifetime) → образование (10K+ учеников) → 7-значный бизнес за <1 года",
          jtbd: "**Core Job:** Быть в курсе AI-революции без 2+ часов скроллинга Twitter/Reddit.\n\n**Functional:** 5-10 важнейших AI-новостей за 5 минут.\n\n**Emotional:** Не FOMO от пропущенных AI-прорывов.\n\n**Social:** Выглядеть информированным в разговорах об AI.\n\n**Switch from:** Мониторинг 20+ источников вручную.",
          monetization: "**Спонсорство:** Баннер $2K + инструмент дня $1.2K → ~$20-26K/мес.\n\n**Pro:** $100 lifetime, 200+ мест в первый день.\n\n**Образование:** Курсы AI-автоматизации, 10K+ учеников.\n\nОбщий доход: $1M+/год к концу 2024. Команда 2-3 человека.",
          marketing: "• Органический рост через Twitter/X (Ben — ProductHunt + Makerpad exit)\n• Кросс-промо с AI newsletter-ами\n• UGC: сообщество приносит новости через Ben's Bites News\n• SEO: 500+ выпусков индексируются\n• AI = самый горячий тренд → попутный ветер\n• Личный бренд: ex-ProductHunt, ex-Zapier",
          impact: "**Для читателя:** 20+ источников → 1 email, 5 мин. FOMO → информированность.\n\n**Для компании:** 150K+ подписчиков. $1M+/год. 10K+ учеников. Де-факто утренний AI-брифинг для tech.",
          tocConstraint: "**Ограничение:** Время куратора — 100+ источников ежедневно не масштабируется.\n\n**Решение:** Community UGC с голосованием. Сам фокусируется на editorial voice.\n\n**Второе:** Потолок CPM → пробит через education (LTV $100+ vs $0.15/подписчик от рекламы).",
          trizContradictions: "**ТП #1:** Больше выпусков (касания) vs ручная курация (выгорание). #15 Динамичность: UGC-платформа с голосованием.\n\n**ТП #2:** Глубокий контент (Pro) vs краткость (free). #1 Дробление: бесплатный дайджест 5 мин + Pro deep-dives.\n\n**Физическое:** Бесплатный (рост) И Платный (revenue). Freemium + lifetime Pro + спонсорство free.",
          conditions: "**Тема:** Взрывной рост (AI 2022-2026), шум зашкаливает.\n\n**Куратор:** Recognized expert с аудиторией (ProductHunt + Makerpad).\n\n**Порог:** Email + Beehiiv за $0.\n\n**Виральность:** Тема, о которой говорят.\n\n**НЕ работает:** Узкая ниша <50K, нет бренда, стабильная тема без FOMO.",
          mvpVersion: "**Гипотеза:** Ежедневный AI-дайджест наберёт 1K подписчиков за 30 дней.\n\n**Эксперимент:** Substack/Beehiiv, 5 выпусков, 200 знакомым. Ежедневно + cross-promo с 3-5 newsletter-ами.\n\n**Метрика:** 1K за 30 дней = тема жизнеспособна. <500 = pivot.\n\n**Следующий шаг:** Community submission + первый спонсор при 5K+ ($500-1K/выпуск).",
        },
      },
      {
  ...
  },
  {
    ...
    examples: [
      {
        company: "Brett Malinowski / State AI",
        detail: "$3-3.5M/год, $20-40K/ролик. 400K YouTube. AI-коммерческие видео через Kling",
        caseStudy: {
          mechanicInAction: "• Brett Malinowski (22 года, 400K YouTube) через State AI снимает AI-видеорекламу за $20-40K\n• Процесс: клиент записывает себя дома → Brett генерирует 10 концептов (Claude) → AI-оверлей через Kling поверх реального видео\n• Правило: идея ролика должна быть невозможна для традиционной съёмки\n• State AI: ~$250-290K/мес ($3-3.5M/год)\n• Бэкграунд: 8 лет контент-креатор, NFT/крипто YouTube, основал WGMI Labs\n• Маржа 85-95%: себестоимость $2-5K (AI + 1 человек 1-2 нед)",
          jtbd: "**Core Job:** Wow-видео для запуска продукта, невозможное традиционно, за вменяемый бюджет.\n\n**Emotional:** Бренд на переднем крае технологий.\n\n**Social:** Ролик который шерят — «смотри что можно с AI».\n\n**Related:** Не нанимать команду из 20 человек на 3 месяца.",
          monetization: "**Проектная:** $20-40K за AI-коммерческий ролик. Себестоимость $2-5K → маржа 85-95%.\n\n**Масштаб:** $3-3.5M/год, команда 1-3 человека.\n\n**Доп. потоки:** YouTube 400K, подкаст, newsletter (Beehiiv), курсы WGMI Labs, лидген-агентство.",
          marketing: "• YouTube-first: подкаст с AI-предпринимателями = контент-маркетинг\n• Каждый ролик = портфолио\n• Inbound через 400K подписчиков\n• «22-летний режиссёр AI-рекламы» — возраст как PR-хук\n• Newsletter Beehiiv для прогрева",
          impact: "**Для клиента:** Стоимость: $200K-1M → $20-40K (10-50x). Время: 2-3 мес → 1-2 нед. Команда: 20+ → 1.\n\n**Для компании:** $3-3.5M/год, 1-3 человека. Стартап с $30K получает ролик уровня Super Bowl.",
          tocConstraint: "**Ограничение:** Творческое видение Brett — лично генерирует концепты, max 3-4 проекта одновременно.\n\n**Решение:** Высокий ценник ($20-40K) компенсирует низкий throughput. Техническая часть делегируется.\n\n**Куда сместилось:** От agency к productized service (шаблоны, обучение режиссёров).",
          trizContradictions: "**ТП #1:** Уникальный креатив vs Масштабируемость. #1 Сегментация: концепт (Brett) и исполнение (команда/AI) разделены.\n\n**ТП #2:** AI-видео невозможное для камеры, но с человеческими эмоциями. #35 Изменение параметров: клиент записывает реальные эмоции, AI меняет визуальный слой.\n\n**Физическое:** Дешёвый (для клиента) И Дорогой (для маржи). Себестоимость низкая (AI), воспринимаемая ценность высокая (wow).",
          conditions: "**Когда работает:** Launch video с wow-фактором. Бюджет $20-50K. Сильный личный бренд для inbound. AI quality прошёл uncanny valley.\n\n**НЕ работает:** Фотореализм кино. Нет бренда → холодные продажи невозможны. SMB $1-5K — маржа не оправдывает.",
          mvpVersion: "**Гипотеза:** Стартапы заплатят $15-20K за AI-ролик невозможный для камеры.\n\n**Эксперимент:** 1 ролик бесплатно для знакомого стартапа. Behind-the-scenes на YouTube/Twitter.\n\n**Метрика:** 2 inbound-запроса через контент за 30 дней.\n\n**Стек:** Kling/Runway + Claude + CapCut/DaVinci.",
        },
      },
      {
